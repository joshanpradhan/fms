                    ...
                    <div class="col-lg-4 col-md-5">
                        <div class="card card-user">
                            ...
                            <div class="content">
                             ...
                             <form method="POST" action="<?php echo CUSTOMER_ACTION?>" enctype="multipart/form-data">  
                                ...
                                <form method="POST" action="<?php echo CUSTOMER_ACTION?>">
                                     <input type="hidden" name="users_id" value="<?php echo $users['users_id']?>"/> 
                                            <div class="form-group">
                                                <label>Role</label>
                                                <input type="text" class="form-control border-input" placeholder="Username" name ="roles" value="Customer" readonly="readonly">
                                            </div>
                                            <div class="form-group">
