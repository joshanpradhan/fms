                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="POST" action="<?php echo ADMIN_ACTION?>">
                                          ...
                                          <div class="form-group">
                                                <input type="hidden" class="form-control border-input" name="users_id" value="<?php echo $row['users_id']?>">
                                            </div>
                                          <div class="form-group">
                                                <input type="hidden" class="form-control border-input" name="futsals_id" value="<?php echo $row['futsals_id']?>">
                                            </div>
                                          <div class="form-group">
                                                <input type="hidden" class="form-control border-input" name="grounds_id" value="<?php echo $row['grounds_id']?>">
                                            </div>
                                          
                                            <div class="form-group">
                                                <label>Customer</label>
                                                <input type="text" class="form-control border-input"  value="<?php echo $row['customername']?>">
                                            </div>
                                        
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Futsal</label>
                                                <input type="text" class="form-control border-input"  value="<?php echo $row['futsalname']?>">
                                            </div>
                                        
                                            <div class="form-group">
                                                <label>Ground</label>
                                                <input type="text" class="form-control border-input"  value="<?php echo $row['groundname']?>">
                                            </div>
                                           
                                            <div class="form-group">
                                                <label>Resquest Date</label>
                                                <input type="text" class="form-control border-input"  value="<?php echo $row['request_date']?>">
                                            </div>
                                            <div class="form-group">
                                                <label>Resquest Time</label>
                                                <input type="text" class="form-control border-input"  value="<?php echo $row['request_time']?>">
                                            </div>
                                            <div class="form-group">
                                                <label>Registration</label>
                                                <input type="text" class="form-control border-input"  value="<?php echo $row['reg_date']?>">
                                            </div>
                                            <div class="form-group">
                                                <label>Price</label>
                                                <input type="num" class="form-control border-input" value="<?php echo $row['price']?>">
                                            </div>
                                    <div class="text-center">

                                         <button type="submit" class="btn btn-danger" name="update_reservation">Delete</button>
                                    </div>
