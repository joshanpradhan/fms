            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h2 class="title">Futsals List <a href="<?php echo CREATE_FUTSAL_PAGE?>" class="btn btn-success">Add Futsals
                                    </a></h2>
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
                                    <thead>
                                        ...
                                        <th><i class="fas fa-exclamation text-danger">Action</i></th>
                                    </thead>
                                <tbody>
            <?php
                $conn = db_get_conn();
                ...
                if ($result = $conn->query($query)){
                    ...
                    while ($row = $result->fetch_assoc()){
                                ...
                                echo   "<tr>
                                        ...
                                        <td>{$row['reg_date']}</td>
                                         <td>
                                            <a href='update_futsal.php?futsals_id={$row['futsals_id']}'><i class='fas fa-edit  text-success h5'></i> 
                                            <a href='delete_futsal.php?futsals_id={$row['futsals_id']}'><i class='fas fa-trash text-danger h5'></i></a>
                                        </td>
                                        </tr>
                                        ";
                                     $count++;
