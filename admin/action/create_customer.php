            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-7">
                        <div class="card">
                            <div class="header">
                                <h4 class="text-danger">Add New Customer</h4>
                            </div>
                            <div class="content">
                                <form method="POST" action="<?php echo ADMIN_ACTION?>">
                                             ...
                                             <div class="form-group">
                                                ...
                                                name="roles_id" value="3">
                                            </div>
                                    
                                            <div class="form-group">
                                                <label>Role</label>
                                                <input type="text" class="form-control border-input" 
                                                 value="Customer" readonly="readonly">
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-danger" name="create_customer">Add Customer</button>
                                    </div>
