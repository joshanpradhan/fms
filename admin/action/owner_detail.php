            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h2 class="title">Owners List<a href="<?php echo CREATE_OWNER_PAGE?>" class="btn btn-danger">Add Owner Users
                                </a></h2>
                            </div>
                ...
                WHERE roles_id= '2'";
                    ...
                    while ($row = $result->fetch_assoc()){
                                ...
                                echo   "<tr>
                                        ...
                                        <td>{$row['reg_date']}</td>
                                        <td>
                                        <a href='update_owner.php?users_id={$row['users_id']}'><i class='fas fa-user-edit text-warning h5'></i></a>
                                        <a href='delete_owner.php?users_id={$row['users_id']}'><i class='fas fa-trash text-danger h5'></i></a>
                                         </td>
                                        </tr>
                                        ";
                                     $count++;
