...
if(isset($_GET['users_id']))
    {   
        if(is_numeric($_GET['users_id']))
        {
            ...
            $query = "
                    SELECT
                        users_id, fullname, email, mobileno, address 
                        FROM tblusers 
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-4 col-md-5">
                        <div class="card card-user">
                            ...
                            <div class="content">
                               <div class="content">
                                <div class="author">
                                  <img src="<?php echo FACES_IMG.$users['img'];?>" alt="<?php echo $users['fullname'];?>"/>
                                  <hr>
                    ...
                    <div class="col-lg-8 col-md-7">
                        <div class="card">
                            <div class="header">
                                <h4 class="title"> Delete Profile</h4>
                            </div>
                            <div class="content">
                                <form method="POST" action="<?php echo OWNER_ACTION?>">
                                    ...
                                    <div class="text-center">
                                         ...
                                         <button type="submit" class="btn btn-danger" name="delete_customer">Delete Profile</button>
                                    </div>
