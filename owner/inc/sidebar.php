    ...
    <!--     Tip 1: you can change the color of the sidebar's background using: data-background-color="white | black"
     ...
     -->
        ...
        <div class="sidebar-wrapper">
            <div>
                <h4 style="color:red; text-align:center;"><?php echo $_SESSION['session']['users']['fullname']; ?></h4>
                <h6 style="color:red; text-align:center;"><?php echo $_SESSION['session']['users']['roles']; ?></h6>
            </div>

            <ul class="nav">
                <li>
                    <a href="<?php echo OWNER_PAGE?>">
