...
<html lang="en">
    ...
    <?php require_once('./../inc/navbar.php');
     ...
     <div class="container mt-5">
        <div class="row">
           <div class="col-12">
            <h2 class="text-center text-secondary" style="word-spacing: 5px; line-height:1.3;"><strong><i class="fas fa-envelope-open"></i> Contact Us</strong></h2>
          </div>
        </div>
      </div>
              ...
              <div class="row justify-content-center">
                ...
                <form method="POST" action="<?php echo CORE_ACTION ?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="example@mail.com" name="email">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="exampleFormControlTextarea1" rows="6" placeholder="Your message" name="message"></textarea> 
                    </div>
                    <button type="submit" class="btn w-100 btn-secondary" name="users_messages">Send</button>
                  </form>
            </div>
        </div>   
    </div>
